  ...
  return (
    <Stack bg="bg.emphasized" height="100vh">
      <Box h="100%" bg="bg.subtle" p={2} m={4} borderRadius="md" boxShadow="sm">
        <Stack bg="bg.info" justify="space-around" align="center" p={4}>
          <Text fontSize="4xl" fontWeight="bold" color="fg.muted">Jason Smith</Text>
          <Text fontSize="2xl" fontWeight="bold" color="fg.muted">Software Engineer | Budding Full Stack Developer | Creative</Text>
        </Stack>
